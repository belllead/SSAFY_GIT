...
public class Person {
	...
	static String species = "homo sapiens sapiens ludens";
	
	// static 키워드 x => 인스턴스 변수
	String name;
	int age;
	...
	// 메서즈 오버로딩: 이름이 같은 메서드 여러개를 만들 수 있다.
	// 파라미터가 달라야 함!
	...
	// - 이름을 똑같이 할 수 있음
	// addInt(), addDouble() 과 같이 만들지 않아도 됨 => 생산성 높아짐
	
	
	// 메서드의 종료
	// - 블록의 끝을 만날 때
	// - return 문을 만날 때(void에서도 return문을 쓸 수 있음)
